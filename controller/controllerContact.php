...
$controller = 'contact';
 ...
 switch ($action) {
     ...
     case "created":
         ...
         && isset($_REQUEST['email'])  && isset($_REQUEST['budget'])
         && isset($_REQUEST['phone'])  && isset($_REQUEST['organization'])
         && isset($_REQUEST['message'])
            ...
            $id = NULL;
                 ...
                 $u = new ModelContact($name, $lastname, $email ,$budget , $phone, $organization, $message);	
                 $tab = array(
                 "id" => $id,    
                 "name" => $name,
                 "lastname" => $lastname,
